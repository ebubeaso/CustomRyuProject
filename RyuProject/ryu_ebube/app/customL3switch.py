...
class LayerThreeSwitch13(app_manager.RyuApp):
    #Part 1: give the OpenFlow version and initialize the class
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]
    def __init__(self, *args, **kwargs):
        super(LayerThreeSwitch13, self).__init__(*args, **kwargs)
    ...
    def switch_features_handler(self, ev):
        """handles the message of a given OpenFlow switch, the OpenFlow protocol
        used and the parser to parse the OpenFlow message"""
    ...
    def _packet_in_handler(self, ev):
        """Handles the message from a given OpenFlow switch, as well as the 
        OpenFlow protocol used and a parser to parse OpenFlow messages/data"""
        msg = ev.msg
        ...
        if out_port != ofproto.OFPP_FLOOD:
            ...
            if eth.ethertype == ether_types.ETH_TYPE_IP:
                ...
                """verify the buffer id to see if it is valid (want to prevent
                sending both the flow mod and packet out at the same time)"""
